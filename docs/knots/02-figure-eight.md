...
`reference-samples-skryagin/skr-03-figure-eight.jpg` — рис. 3 «Восьмерка», три стадии: заводка со стрелкой, плоская восьмёрка, затянутый узел.
...
`reference-samples/lj-03-stopper-a.jpg, lj-03-stopper-b.jpg` — стопорный узел; восьмёрки в статье нет, но принцип подачи тот же.
