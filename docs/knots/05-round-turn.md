...
`reference-samples-skryagin/skr-12-round-turn-two-half-hitches.jpg` — рис. 12 «Простой штык со шлагом», он же round turn and two half hitches; рядом применения на рыме и гаке.
...
**Контраст:** `skr-10-two-half-hitches-right-vs-wrong.jpg` — рис. 10,
правильно завязанный штык и перевёрнутый. Отличие в том, куда выходит
ходовой конец после второй колышки; у перевёрнутого узел затягивается.
